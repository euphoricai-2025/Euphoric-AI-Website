        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="relative flex flex-col items-start">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://calendly.com/euphoricai-ai/demo" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand-teal text-sm transition-colors focus:outline-none focus:ring-0 active:outline-none">Book Demo</a></li>
