...
import { Settings, Zap, Link as LinkIcon, ArrowRight, CheckCircle, Workflow, Target, Headphones, Search, ChevronDown, Globe, Users, BarChart3, Clock, Shield, Play } from 'lucide-react';
...
const MakeIntegration = () => {
  ...
  const industries = [
    { name: 'E-commerce', description: 'Order processing and fulfillment automation' },
    { name: 'Healthcare', description: 'Patient management and scheduling systems' },
    { name: 'Finance', description: 'Account management and transaction processing' },
    { name: 'Real Estate', description: 'Lead nurturing and property management' },
    { name: 'Logistics', description: 'Shipment tracking and coordination' },
    { name: 'Manufacturing', description: 'Supply chain and inventory management' }
  ];

  const howItWorks = [
    { step: 1, title: 'Connect Your Apps', description: 'Choose from 1000+ pre-built connectors or create custom integrations' },
    { step: 2, title: 'Design Workflows', description: 'Use drag-and-drop interface to build automation sequences' },
    { step: 3, title: 'Add AI Triggers', description: 'Connect your AI voice agents as workflow triggers and actions' },
    { step: 4, title: 'Deploy & Monitor', description: 'Launch your automations and track performance in real-time' }
  ];
    ...
    <div className="pt-16 bg-euphoric-surface min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            >
              <h1 className="font-bold mb-6 leading-tight tracking-tight" style={{ fontSize: 'clamp(2.5rem, 3.8vw, 3.2rem)' }}>
                <span className="bg-gradient-to-r from-brand-teal via-brand-blue to-brand-gold bg-clip-text text-transparent">Make Integration</span>
                <br />
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Get Make Integration Demo</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">Make Integration Solutions</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">Popular Workflow Templates</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get up and running with Make automation in four simple steps.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Make automation works across all business sectors to streamline operations.
            </p>
          </motion.div>
