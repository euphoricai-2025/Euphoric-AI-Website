...
import { Heart, Calendar, UserCheck, FileText, ArrowRight, CheckCircle, TrendingUp, Shield, Phone, Clock, Settings, Play, Globe, BarChart3, MessageCircle, Headphones, Loader2, CreditCard, Users, Clipboard, ChevronDown, Search } from 'lucide-react';
  ...
  const useCases = [
    ...
    },
    {
      ...
      benefits: [
        ...
        'Eliminate manual verification calls',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="font-bold mb-6 leading-tight tracking-tight" style={{ fontSize: 'clamp(2.5rem, 3.8vw, 3.2rem)' }}>
                <span className="bg-gradient-to-r from-brand-teal via-brand-blue to-brand-gold bg-clip-text text-transparent">Healthcare</span>
                <br />
              ...
              <p className="text-xl text-gray-600 mb-4 leading-relaxed no-word-break">
                <TextAnimate animation="blurInUp" by="word" once>
                  Reduce no-shows, improve patient follow-ups, and deliver test results with AI agents built for healthcare compliance and patient care.
                </TextAnimate>
              </p>

              <p className="text-lg text-gray-500 mb-8 leading-relaxed">
                <span className="font-bold text-red-600">32% no-show rates costing you thousands?</span> Our AI reduces no-shows to <span className="font-bold text-green-600">8%</span> while maintaining <span className="font-bold">100% HIPAA compliance</span>.
              </p>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-teal/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">No-Show Reduction</div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-blue/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Fewer Readmissions</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gold/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Revenue Recovery</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gray/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">HIPAA Compliant</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              >
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-teal/20 to-brand-blue/20 rounded-full px-6 py-2 mb-6">
                  ...
                  <span className="text-gray-700 font-semibold">Healthcare Integrations</span>
                </div>
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Seamless integration with EMR systems, scheduling platforms, and insurance verification tools for complete workflow automation.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3 p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200/50">
                    ...
                    <span className="font-semibold text-gray-900">EMR Systems</span>
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-white/90 mb-8">
              Join healthcare providers using HIPAA-compliant AI agents to reduce no-shows, improve patient outcomes, and enhance operational efficiency.
            </p>
