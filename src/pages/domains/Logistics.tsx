...
import { Truck, Package, Navigation, Phone, ArrowRight, CheckCircle, TrendingUp, Shield, Clock, Settings, Play, Globe, BarChart3, MessageCircle, Headphones, Loader2, CreditCard, Users, Clipboard, ChevronDown, Search, MapPin } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      benefits: [
        'Reduce missed deliveries by up to 65%',
        'Improve customer satisfaction by 40%',
        'Save 20+ staff hours weekly',
        'Decrease re-delivery costs significantly'
      ]
    },
    {
      icon: Navigation,
    ...
    },
    {
      ...
      benefits: [
        'Reduce support call volume by 50%',
  ...
  const painPoints = [
    {
      ...
      description: 'Failed delivery attempts cost logistics companies $2.8 billion annually',
      impact: 'Customers miss 20-25% of deliveries due to poor communication, requiring expensive re-delivery attempts'
    },
    {
      title: 'Route Inefficiencies',
      description: 'Traffic delays and poor coordination create 15-20% additional costs',
      impact: 'Manual coordination leads to confused drivers and increased fuel consumption'
    },
    {
      title: 'Customer Service Overload',
      description: '60% of support time spent on repetitive tracking inquiries',
      impact: 'Complex routing explanations lead to poor customer experiences and higher staffing costs'
    }
  ];

  const results = [
    { metric: '65%', label: 'Fewer Missed Deliveries', description: 'Reduction in failed attempts' },
    { metric: '35%', label: 'More Efficient Routes', description: 'Better delivery coordination' },
    { metric: '50%', label: 'Less Support Call Volume', description: 'Automated inquiry handling' },
    { metric: '$2.8B', label: 'Industry Cost Savings', description: 'From delivery optimization' }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-brand-teal text-sm font-semibold mb-6 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 hover:bg-white/15">
                <Truck className="w-4 h-4 mr-3 text-brand-teal" />
              ...
              <h1 className="font-bold mb-6 leading-tight tracking-tight" style={{ fontSize: 'clamp(2.5rem, 3.8vw, 3.2rem)' }}>
                <span className="bg-gradient-to-r from-brand-teal via-brand-blue to-brand-gold bg-clip-text text-transparent">Logistics</span>
                <br />
              ...
              <p className="text-xl text-gray-600 mb-4 leading-relaxed no-word-break">
                <TextAnimate animation="blurInUp" by="word" once>
                  Reduce missed deliveries, optimize routes, and enhance customer service with AI agents built for the logistics industry.
                </TextAnimate>
              </p>

              <p className="text-lg text-gray-500 mb-8 leading-relaxed">
                <span className="font-bold text-red-600">25% delivery failure rates costing millions?</span> Our AI reduces missed deliveries to <span className="font-bold text-green-600">8%</span> while cutting <span className="font-bold">fuel costs by 25%</span>.
              </p>
                  ...
                  <div className="relative z-10">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600 text-sm">
                        See delivery optimization AI in action
                      </p>
                    </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-teal/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Fewer Missed Deliveries</div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-blue/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Route Efficiency Gain</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gold/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Support Call Reduction</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gray/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Fuel Cost Savings</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-teal/20 to-brand-blue/20 rounded-full px-6 py-2 mb-6">
                  ...
                  <span className="text-gray-700 font-semibold">Logistics Integrations</span>
                </div>
                ...
                <h2 className="font-bold mb-6 leading-tight tracking-tight" style={{ fontSize: 'clamp(2.5rem, 3.8vw, 3.2rem)' }}>
                  ...
                  <br />
                  <span className="bg-gradient-to-r from-gray-600 via-gray-700 to-brand-gold bg-clip-text text-transparent">Your Logistics Stack</span>
                </h2>
                
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Seamless integration with fleet management systems, tracking platforms, and route optimization tools for complete logistics automation.
                </p>
            ...
            >
              ...
              >
                ...
                <Circle ref={trackingRef} className="absolute top-8 left-1/2 transform -translate-x-1/2">
                  <Navigation className="w-6 h-6 text-gray-700" />
                </Circle>
                
                <Circle ref={routeRef} className="absolute left-8 top-1/2 -translate-y-1/2">
                  <MapPin className="w-6 h-6 text-gray-700" />
                </Circle>
                
                <Circle ref={fleetRef} className="absolute right-8 top-1/2 -translate-y-1/2">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="font-bold mb-6 leading-tight tracking-tight text-white" style={{ fontSize: 'clamp(2.5rem, 3.8vw, 3.2rem)' }}>
              <span className="text-white">Ready to Optimize</span>
              <br />
              <span className="text-white">Your Logistics Operations?</span>
            </h2>
