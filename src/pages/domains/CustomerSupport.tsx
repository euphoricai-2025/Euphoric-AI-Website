...
import { Headphones, Clock, MessageCircle, Users, ArrowRight, CheckCircle, TrendingUp, Shield, Phone, Calendar, Settings, Play, Globe, BarChart3, FileText, Loader2, CreditCard, Clipboard, ChevronDown, Search } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      benefits: [
        ...
        'Resolve 75% of inquiries automatically',
    ...
    },
    {
      ...
      benefits: [
        'Reduce incoming support volume by 40%',
    ...
    },
    {
      ...
      benefits: [
        ...
        'Increase product adoption by 45%',
        'Lower churn rates by 60%',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed">
                <span className="font-bold text-red-600">80% of support tickets are repetitive?</span> Our AI handles <span className="font-bold text-green-600">75% automatically</span> while reducing costs by <span className="font-bold">60%</span>.
              </p>
                  ...
                  <div className="relative z-10">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600 text-sm">
                        See 24/7 AI customer support in action
                      </p>
                    </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-teal/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Inquiries Automated</div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gold/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Support Coverage</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gray/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Customer Rating</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-teal/20 to-brand-blue/20 rounded-full px-6 py-2 mb-6">
                  <Headphones className="w-5 h-5 text-brand-teal" />
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Seamless integration with CRM systems, ticketing platforms, and knowledge bases for complete support workflow automation.
                </p>
            ...
            >
              ...
              >
                ...
                <Circle ref={ticketingRef} className="absolute left-8 top-1/2 -translate-y-1/2">
                  <Clipboard className="w-6 h-6 text-gray-700" />
                </Circle>
                
                <Circle ref={knowledgeRef} className="absolute right-8 top-1/2 -translate-y-1/2">
