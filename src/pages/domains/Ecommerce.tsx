...
import { ShoppingBag, CreditCard, Truck, Phone, ArrowRight, CheckCircle, TrendingUp, Shield, Play, Globe, BarChart3, MessageCircle, Headphones, Loader2, Users, Clipboard, ChevronDown, Search } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      benefits: [
        ...
        'Generate $250,000+ monthly revenue',
    ...
    },
    {
      ...
      benefits: [
        'Reduce payment failures by 60%',
        'Recover 45% of declined transactions',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-brand-teal text-sm font-semibold mb-6 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 hover:bg-white/15">
                <ShoppingBag className="w-4 h-4 mr-3 text-brand-teal" />
              ...
              <p className="text-xl text-gray-600 mb-4 leading-relaxed no-word-break">
                <TextAnimate animation="blurInUp" by="word" once>
                  Recover abandoned carts, resolve payment issues, and drive repeat purchases with AI agents built for e-commerce success and revenue growth.
                </TextAnimate>
              </p>

              <p className="text-lg text-gray-500 mb-8 leading-relaxed">
                <span className="font-bold text-red-600">69.8% cart abandonment costing thousands?</span> Our AI recovers <span className="font-bold text-green-600">30% of abandoned carts</span> while driving <span className="font-bold">$250K+ monthly revenue</span>.
              </p>
                  ...
                  <div className="relative z-10">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600 text-sm">
                        See cart recovery AI in action
                      </p>
                    </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-blue/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Payment Success Rate</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gold/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Monthly Revenue</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-gray/30 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Higher LTV</div>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-2xl"></div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Seamless integration with Shopify, payment processors, and shipping providers for complete e-commerce automation.
                </p>
            ...
            >
              ...
              >
                ...
                <Circle ref={shopifyRef} className="absolute top-8 left-1/2 transform -translate-x-1/2">
                  <ShoppingBag className="w-6 h-6 text-gray-700" />
                </Circle>
                
                <Circle ref={paymentsRef} className="absolute left-8 top-1/2 -translate-y-1/2">
                  <CreditCard className="w-6 h-6 text-gray-700" />
                </Circle>
                
                <Circle ref={shippingRef} className="absolute right-8 top-1/2 -translate-y-1/2">
